...
using Kaizen.Sessions;
using Kaizen.Web.Models.Account;
using Kaizen.Web.Views.Shared.Components.TenantChange;
...
{
    public class AccountController : KaizenControllerBase
    {
