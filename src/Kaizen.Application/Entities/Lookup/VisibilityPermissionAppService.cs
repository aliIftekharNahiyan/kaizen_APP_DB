...
{
    public class VisibilityPermissionAppService : AsyncCrudAppService<Lookup, LookupDto, long, PagedLookupResultRequestDto, CreateLookupDto, LookupDto>, ILookupAppService
    {
        public VisibilityPermissionAppService(
        ...
        protected override IQueryable<Lookup> CreateFilteredQuery(PagedLookupResultRequestDto input)
        {
            ...
            return Repository.GetAllIncluding()
                ...
                .Where(x => x.IsActive == true && x.LookTypeId == Convert.ToInt64( CommonEnum.LookupType.VisibilityPermission));
        }
