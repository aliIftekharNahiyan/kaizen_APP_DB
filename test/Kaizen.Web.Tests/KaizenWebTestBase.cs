...
{
    public abstract class KaizenWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static KaizenWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(KaizenWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<KaizenDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<KaizenDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<KaizenDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<KaizenDbContext, Task<T>> func)
        {
            T result;
